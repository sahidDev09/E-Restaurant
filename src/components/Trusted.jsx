...
const Trusted = () => {
  return (
    ...
    <div className=" container mx-auto bg-slate-100 p-10 rounded-lg">
      ...
      <div className="parant_div h-[60%] gap-7  grid sm:grid-cols-5 grid-cols-2 scale-75 items-center justify-between opacity-75">
        <div>
        ...
        <div>
          <img className=" w-[200px] h-[100px]" src={cocacola} alt="cocacola" />
        </div>
      </div>
    </div>
